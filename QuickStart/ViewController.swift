...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        print("viewdidload viewcontroller is called")
        super.viewDidLoad()
//        connectView.isHidden = true
    ...
    func signinAction() {
        ...
        print("Attempting sign-in with UserID: \(userID), Nickname: \(nickname)")
        ...
        SendbirdUI.connect { [weak self] user, error in
            ...
            if let user = user {
                ...
                // Present the groupChannelItemView after successful sign-in
                self?.presentGroupChannelItemView()
            }
        }
    }

    
    private func presentGroupChannelItemView() {
    ...
    func presentMySettingsViewController() {
        let mySettingsViewController = MySettingsViewController()
        mySettingsViewController.mainViewController = self // Set the reference to self
        present(mySettingsViewController, animated: true, completion: nil)
    }
}
